...
public class LoginView extends MyActivity implements UmengLogin.OnLoginListener,
    ...
    @DebugLog
    public static void start(Context context, String usrname, String password) {
    ...
    public void sendMessage(){
        ...
        ((MyApplication)getApplication()).setLoginController(new LoginController(usrname, password));
    }
}
