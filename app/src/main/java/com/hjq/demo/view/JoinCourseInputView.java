    ...
    protected void initView() {
        ...
        mSearchView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ArrayList<Map<String,Object>> list = joinCourseController.getCourseInfoById(courseId);
                if(list == null){
                    toast("课程不存在，请查验后重新输入");
                    return;
                }

                CourseAdapter adapter = new CourseAdapter(getActivity(), list, joinCourseController);
