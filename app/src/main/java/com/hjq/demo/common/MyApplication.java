...
public final class MyApplication extends Application {
    ...
    public JoinCourseController getJoinCourseController() {
        return joinCourseController;
    }

    public void setJoinCourseController(JoinCourseController joinCourseController) {
        this.joinCourseController = joinCourseController;
    }

    //当前邀请学生加入课程控制器
    private InviteStuController inviteStuController = null;

    public InviteStuController getInviteStuController() {
        return inviteStuController;
    }

    public void setInviteStuController(InviteStuController inviteStuController) {
        this.inviteStuController = inviteStuController;
    }

    //当前创建课程控制器
    private CreateCourseController createCourseController = null;

    public CreateCourseController getCreateCourseController() {
        return createCourseController;
    }

    public void setCreateCourseController(CreateCourseController createCourseController) {
