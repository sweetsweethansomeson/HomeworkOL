...
public final class HomeActivity extends MyActivity
    ...
    protected void initData() {
        ...
        mPagerAdapter.addFragment(JoinCourseInputView.newInstance());
        mPagerAdapter.addFragment(TestFragmentB.newInstance());
        mPagerAdapter.addFragment(StudentMessageView.newInstance());
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.home_course:
                mPagerAdapter.setCurrentItem(JoinCourseInputView.class);
                return true;
            case R.id.home_assignment:
                mPagerAdapter.setCurrentItem(TestFragmentB.class);
                return true;
            case R.id.home_message:
                mPagerAdapter.setCurrentItem(StudentMessageView.class);
                return true;
            case R.id.home_me:
