...
public class MessageAdapter extends BaseAdapter {
    ...
    public MessageAdapter(Context context, ArrayList<Map<String, Object>> data, MessageController messageController) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if((boolean)list.get(position).get("read")){
            viewHolder.btn_read.setText("已读");
            viewHolder.btn_read.setEnabled(false);
        }
        else {
            viewHolder.btn_read.setText("未读");
    ...
    public void setClick(ViewHolder viewHolder, int position){
        viewHolder.btn_read.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                viewHolder.btn_read.setText("已读");
                viewHolder.btn_read.setEnabled(false);
                messageController.changeReadStateOf(position, User.STUDENT);
            }
        });
                ...
                new MessageDialog.Builder(context)
                        ...
                        .setListener(new MessageDialog.OnListener() {
                            ...
                            public void onConfirm(BaseDialog dialog) {
                                messageController.deleteOf(position, User.STUDENT);
